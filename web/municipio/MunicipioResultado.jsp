<html>
    ...
    <body>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h1 align="center"><%=request.getAttribute("titulo")%></h1>
        </div>
        <%
            String mensaje = (String) request.getAttribute("mensaje");
        %>

        <div class="container p-30" style="padding: 30px; margin-bottom:100px;">
            <div class="row">
                <p align="center">
                    <font color="red">
                    <%=mensaje%></font>
            ...
            <div class="row">
                <p align='center'>
                    <a href="/RA6_LopezAngel/ControlMunicipio?accion=<%=request.getAttribute("accion")%>"><%=request.getAttribute("boton")%></a>
                </p>  
            </div>
        </div>
