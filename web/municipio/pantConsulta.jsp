...
<html>
    <head>
        <title>MUNICIPIOS A CONSULTAR</title>
        <meta charset="utf-8">
    ...
    <jsp:forward page="/ControlMunicipio?accion=resConsulta"/>
    <% } %>
    <body>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2>SELECCIONA EL PAIS A CONSULTAR</h2>
        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="btn-group-vertical">  
                            <input class="btn btn-dark" type="submit" name="modificar" 
                                   value="Consultar municipios del Pais" />        
