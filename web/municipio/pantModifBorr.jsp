...
<html>
    <head>
        <title>MODIFICACION Y BORRADO DE MUNICIPIO</title>
        <meta charset="utf-8">
    ...
    <jsp:forward page="/ControlMunicipio?accion=resModBor"/>
    <% } %>
    <body>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2>SELECCIONA EL MUNICIPIO A MODIFICAR O ELIMINAR</h2>
        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="btn-group-vertical">  
                            <input class="btn btn-dark" type="submit" name="modificar" 
                                   value="Modificar el municipio" />        
                            <input class="btn btn-dark" type="submit" name="eliminar" 
                                   value="Eliminar el municipio" />    
