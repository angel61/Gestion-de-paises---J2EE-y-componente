...
<html>
    <head>      
        <title>MODIFICACI&Oacute;N DE PERSONA</title>
        <meta charset="utf-8">
    ...
    <body>
        <jsp:useBean id="persona" scope="request" class="pantalla.Persona" />
        <jsp:setProperty name="persona" property="*"/>
        <% if (request.getParameter("modificar").
                    equals("Modificar persona")) {
                //System.out.println("he pulsado boton");
        %>
        <jsp:forward page="/ControlPersona?accion=modificacion"/>
        <% } %>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2 align="center">MODIFICACI&Oacute;N DE DATOS DE PERSONA</h2>
        </div>
        <%
            Persona p = (Persona) request.getAttribute("personas");
        %>
        <div class="container p-30" style="padding-top: 30px; padding-bottom: 5em;">
            ...
            <form  method="post">
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <p>Nombre de la persona:
                                <input class="form-control" name="nombre" 
                                       required type="text" size="50" maxlength="50" value="<%= p.getNombre()%>" readonly="readonly"  /> 
                            </p>
                        </div>
                        <div class="form-group">
                            <p>Edad: 
                        ...
                        <div class="form-group">
                            <p>N&uacute;mero de vivienda:             
                                <select class="form-control" name="codvivienda">
                                    ...
                                    <option value= <%=v.getCodigo()%> <% if (v.getCodigo() == p.getCodvivienda()) { %>selected<% }%>> 
                        ...
                        <div class="btn-group"> 
                            <input class="btn btn-dark" type="submit" name="modificar" value="Modificar persona">
        ...
        <div class="jumbotron text-center" style="margin-bottom: 0;">
            <a href="/RA6_LopezAngel/ControlPersona?accion=pantModifBorr">Modificaci&oacute;n de persona</a>
            <br/><br/>
