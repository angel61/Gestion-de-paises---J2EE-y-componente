...
<html>
    <head>
        <title>MODIFICACION Y BORRADO DE PERSONA</title>
  <meta charset="utf-8">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    ...
    <jsp:useBean id="persona" scope="request" 
                 class="pantalla.Persona" />
    <jsp:setProperty name="persona" property="*"/>
    <%
        if (request.getParameter("nombre") != null) { %>
    <jsp:forward page="/ControlPersona?accion=resModBor"/>
    <% } %>
    <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2>SELECCIONA EL PERSONA A MODIFICAR O ELIMINAR</h2>
        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <p>Nombre de la persona:             
                                <select class="form-control" name="nombre">
                                    <%
                                        ArrayList listadpersona = (ArrayList) request.getAttribute("personas");
                                        if (listadpersona != null)
                                            for (int i = 0; i < listadpersona.size(); i++) {
                                                Persona p = (Persona) listadpersona.get(i);%>
                        ...
                        <div class="btn-group-vertical">  
                            <input class="btn btn-dark" type="submit" name="modificar" 
                                   value="Modificar el persona" />        
                            <input class="btn btn-dark" type="submit" name="eliminar" 
                                   value="Eliminar el persona" />    
