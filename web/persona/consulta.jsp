...
<html>
    ...
    <body>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2>LISTADO DE PERSONAS DE <%=request.getAttribute("nombre")%></h2>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered order-column dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr><th>NOMBRE</th><th>EDAD</th><th>COD. VIVIENDA</th></tr>
                            </thead>
                            <tbody
                                <%
                                    ArrayList listapersonas
                                            = (ArrayList) request.getAttribute("personas");
        ...
        <div class="jumbotron text-center" style="margin-bottom: 0;">
            <p>
                <a href="/RA6_LopezAngel/ControlPersona?accion=<%=request.getAttribute("accion")%>">Volver a Consultar</a>
            </p>
            <p>
