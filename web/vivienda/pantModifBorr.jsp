...
<html>
    <head>
        <title>MODIFICACION Y BORRADO DE VIVIENDA</title>
  <meta charset="utf-8">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    ...
    <jsp:forward page="/ControlVivienda?accion=resModBor"/>
    <% } %>
    <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            <h2>SELECCIONA LA VIVIENDA A MODIFICAR O ELIMINAR</h2>
        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="btn-group-vertical">  
                            <input class="btn btn-dark" type="submit" name="modificar" 
                                   value="Modificar el vivienda" />        
                            <input class="btn btn-dark" type="submit" name="eliminar" 
                                   value="Eliminar el vivienda" />    
